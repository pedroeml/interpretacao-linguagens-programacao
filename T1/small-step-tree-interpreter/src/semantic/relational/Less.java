...
public class Less extends BooleanExpression {
    ...
    public Less(ArithmeticExpression exp1, ArithmeticExpression exp2) {
        this.exp1 = exp1;
        this.exp2 = exp2;
    }
    ...
    public AbstractSyntaxTree smallStep(Environment environmentState) {
        if (!(this.exp1 instanceof Literal)) {
            ...
            return new Less(this.exp1, (Literal) this.exp2.smallStep(environmentState)).smallStep(environmentState);
        } else {
