...
public class Or extends BooleanExpression {
    ...
    public Or(BooleanExpression exp1, BooleanExpression exp2) {
        this.exp1 = exp1;
        this.exp2 = exp2;
    }
    ...
    public AbstractSyntaxTree smallStep(Environment environmentState) {
        ...
        if (!(this.exp1 instanceof BooleanLiteral)) {
            ...
            return new Or(this.exp1, (BooleanLiteral) this.exp2.smallStep(environmentState)).smallStep(environmentState);
        } else {
